        ...
        <div>
          <Link href="https://nodejs.org" title="Node.js" target="_blank" rel="noreferrer">
            <em className="select-none">
              <svg className="block dark:hidden" height={isMobile ? 16 : 48} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 289 177" fill="none">
              ...
              <svg className="hidden dark:block" height={isMobile ? 16 : 48} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 319 195" fill="none">

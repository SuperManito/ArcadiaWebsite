...
<Tabs defaultValue="js" updateAnchor>
  <TabsList>
    <TabsTrigger value="js">
      <Icon>skill-icons:javascript</Icon>
      JavaScript / 
      <Icon>skill-icons:typescript</Icon>
      TypeScript
    </TabsTrigger>
    <TabsTrigger value="python">
      <Icon>logos:python</Icon>
      Python
    </TabsTrigger>
    <TabsTrigger value="go">
      <Icon width="30px">logos:go</Icon>
      Go
    </TabsTrigger>
    ...
    <TabsTrigger value="perl">
      <Icon>vscode-icons:file-type-perl</Icon>
      Perl
    </TabsTrigger>
    <TabsTrigger value="c">
      <Icon>skill-icons:c</Icon>
      C
    </TabsTrigger>
  </TabsList>

...
我们对移动端进行了深度适配，推荐以独立应用模式使用。以 <Icon size="1.1em">simple-icons:apple</Icon> iOS 为例，打开 <Icon size="1em">logos:safari</Icon> Safari 浏览器，访问控制面板登录页面并点击分享按钮，选择“添加到主屏幕”，之后在桌面打开即可像原生应用一样快速访问控制面板。

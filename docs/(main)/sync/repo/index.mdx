...
<Tabs items={['cronSettings', 'authSettings']} updateAnchor>
  <Tab id="cronSettings" value="cronSettings">
    <TypeTable
      type={{
        updateTaskList: {
  ...
  <Tab id="authSettings" value="authSettings">
    ...
    <Tabs items={['SSH 配置', 'HTTP 认证']} updateAnchor>
      <Tab id="sshConfig" value="SSH 配置">
        <TypeTable
          type={{
            alias: {
...
<Callout title="如何修改已配置仓库的远程链接地址？">

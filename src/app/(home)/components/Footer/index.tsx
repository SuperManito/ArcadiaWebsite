        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 lg:gap-16 mb-12">
          <div className="flex flex-col">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link className="text-sm text-neutral-600 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/docs/quick-start">安装流程</Link>
              </li>
            </ul>
          </div>
          <div className="flex flex-col">
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-3">
              <li>
                <Link className="text-sm text-neutral-600 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href={gitConfig.url}>GitHub</Link>
              </li>
              <li>
          ...
          <div className="flex flex-col">
            ...
            <ul className="space-y-3">
              <li>
                <Link className="text-sm text-neutral-600 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/docs/api">API 文档</Link>
              </li>
              <li>
                <Link className="text-sm text-neutral-600 dark:text-neutral-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors" href="/docs/openapi">OpenAPI 文档</Link>
              </li>
            </ul>
          </div>
        </div>

  ...
  const items = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        icon: (
          <svg fill="currentColor" fillRule="evenodd" height="1em" viewBox="0 0 256 257" width="1em" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 shrink-0" preserveAspectRatio="xMidYMid">

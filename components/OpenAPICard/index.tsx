        ...
        <Link href={ApifoxHerf} target="_blank" rel="noreferrer">
            <Button size="large" type="text" style={{ height: '56px' }}>
                <svg xmlns="http://www.w3.org/2000/svg" width="101" height="33" fill="none">
                    ...
                    <defs>
                        <linearGradient id="logo-text-white_svg__a" x1="1" x2="28.933" y1="2.529" y2="32.458" gradientUnits="userSpaceOnUse"><stop offset="0.01" stopColor="#FF4385"></stop><stop offset="0.276" stopColor="#FF4274"></stop><stop offset="0.724" stopColor="#FF5C65"></stop><stop offset="1" stopColor="#FF5C35"></stop></linearGradient><linearGradient id="logo-text-white_svg__b" x1="1" x2="28.933" y1="2.529" y2="32.458" gradientUnits="userSpaceOnUse"><stop offset="0.01" stopColor="#FF4385"></stop><stop offset="0.276" stopColor="#FF4274"></stop><stop offset="0.724" stopColor="#FF5C65"></stop><stop offset="1" stopColor="#FF5C35"></stop></linearGradient>
                    </defs>
                </svg>
            </Button>
        </Link>

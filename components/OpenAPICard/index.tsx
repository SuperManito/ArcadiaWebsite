  ...
  const Default = (
    <Space>
      ...
      <Link href={SwaggerHerf} target="_blank" rel="noreferrer">
        <Button size="large" type="text" style={{ height: '56px' }}>
          <Space>
            <Icon icon="devicon:swagger" size="28px" style={{ marginTop: '0.25em' }}></Icon>
          </Space>
          <div style={{ fontWeight: '550', marginBottom: '3px', fontSize: '20px' }}>SwaggerUI</div>
        </Button>
      </Link>
    </Space>
  )
    ...
    <Space>
      ...
      <Link href={SwaggerHerf} target="_blank" rel="noreferrer">
        <Button size="large" type="text" block style={{ height: '48px' }}>
          ...
          <div style={{ fontWeight: '550', marginBottom: '4px', fontSize: '20px' }}>SwaggerUI</div>
        </Button>
      </Link>
    </Space>
  )
